...
## Last update Sun Dec  4 17:33:24 2016 Bonaldi Jordan
##

SRC	=	main.c			\
		methods/display.c	\
		methods/printer.c	\
		handler/flag_handler.c	\
		handler/error_handler.c	\
		handler/help_handler.c	\
		handler/display_handler.c \
		handler/type_handler.c	\
